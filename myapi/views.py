...
class MusicViewSet(ModelViewSet):
    ...
    queryset = (
        Music.objects.all()
        .select_related("main_singer")
        .prefetch_related("genre", "other_singers")
    )
    filter_backends = [SearchFilter, DjangoFilterBackend, OrderingFilter]
    ...
    search_fields = [
        "title",
        "lyrics",
        "main_singer__first_name",
        "main_singer__last_name",
        "main_singer__nick_name",
        "other_singers__first_name",
        "other_singers__last_name",
        "other_singers__nick_name",
        "year",
    ]
...
class StaffViewSet(ModelViewSet):
    ...
    )  # don't forget to import action from rest_framework.decorators
    def me(self, request):
